    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="index.php?uc=categories&action=list">Liste des catégories</a>
          <a class="dropdown-item" href="index.php?uc=categories&action=add">Ajouter une catégorie</a>
        </div>
      </li>
      <li class="nav-item dropdown">
